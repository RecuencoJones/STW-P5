...
import db.datos.PrediccionDia;
import db.datos.PrediccionSemana;
import db.datos.Viento;
...
public class Parser {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File xmlFile = new FileRetriever().getFile(args[0]);
        if(xmlFile==null){
            System.exit(-1);
        }
        ...
        try{
            ...
            List<PrediccionDia> dias = new ArrayList<>();
...
//            System.out.println(prediccionSemana);
            ...
            saveInDatabase(xmlFile.getName(),prediccionSemana);
